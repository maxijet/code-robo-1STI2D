...
const int M1_dir = 4;// installation de la direction du moteur M1
const int M1_speed = 3;// installation de la de vitesse du moteur M1 
const int M2_dir = 4;// installation de la direction du moteur M2
const int M2_speed = 3;// installation de la de vitesse du moteur M2 
const int M3_dir = 4;// installation de la direction du moteur M3
const int M3_speed = 3;// installation de la de vitesse du moteur M3 
